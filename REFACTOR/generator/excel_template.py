...
def _add_instructions(ws):
    ...
    instructions = [
        ...
        ["Action", "Action to perform: navigate, click, fill, verify, wait, wait_for"],
        ["Functions", "Special functions: TOTP (for one-time password generation). For wait_for action: visible/clickable/enabled"],
        ["Text Value", "Text to fill (for 'fill' actions). Use '${TIMESTAMP}' for dynamic timestamp."],
        ["Wait Time", "Wait time in milliseconds (for 'wait' actions) or timeout in milliseconds (for 'wait_for' actions, default 10000ms)"],
        ...
        ["wait_for", "Wait for an element to be visible/clickable/enabled. Use Functions column: visible/clickable/enabled"],
        ["", ""],
        ["Special Functions:", ""],
        ["", ""],
        ...
        ["wait_for Functions:", ""],
        ["", ""],
        ["visible", "Wait for element to be visible on the page"],
        ["clickable", "Wait for element to be visible AND enabled (not disabled)"],
        ["enabled", "Wait for element to be enabled (not disabled, assumes already visible)"],
        ["", ""],
        ["Notes:", ""],
        ["", ""],
