    ...
    try {
            ...
            try {
                ...
                try {
                    ...
                    const userEmail = 'Laxmi_AI_test@yahoo.com';
            ...
            try {
                ...
                try {
                    ...
                    element = page.locator(selector).nth(0);
                    await element.waitFor({ state: 'visible', timeout: 10000 });
                    console.log(`✅ Step 10: Using registry element_id: ID_8fcff2a7`);
                } catch (registry_error) {
                    // Registry lookup failed - test must fail
                    console.log(`❌ Step 10: Registry lookup failed for element_id ID_8fcff2a7: ${registry_error}`);
            ...
            try {
                ...
                try {
                    ...
                    element = page.locator(selector).nth(0);
                    await element.waitFor({ state: 'visible', timeout: 10000 });
                    console.log(`✅ Step 11: Using registry element_id: ID_38253381`);
                } catch (registry_error) {
                    // Registry lookup failed - test must fail
                    console.log(`❌ Step 11: Registry lookup failed for element_id ID_38253381: ${registry_error}`);
            ...
            try {
                ...
                try {
                    ...
                    element = page.locator(selector).nth(0);
                    await element.waitFor({ state: 'visible', timeout: 10000 });
                    console.log(`✅ Step 12: Using registry element_id: ID_07a4c7a7`);
                } catch (registry_error) {
                    // Registry lookup failed - test must fail
                    console.log(`❌ Step 12: Registry lookup failed for element_id ID_07a4c7a7: ${registry_error}`);
                ...
                await page.waitForTimeout(1000);  // Wait after click
                console.log(`✅ Step 12: Clicked input`);
                await page.screenshot({ path: 'storage/screenshots/pw_step12_input.png' });
            } catch (e) {
                console.log(`❌ Step 12: Failed to click input: ${e}`);
            ...
            try {
                ...
                try {
                    ...
                    element = page.locator(selector).nth(0);
                    await element.waitFor({ state: 'visible', timeout: 10000 });
                    console.log(`✅ Step 13: Using registry element_id: ID_ce7aacba`);
                } catch (registry_error) {
                    // Registry lookup failed - test must fail
                    console.log(`❌ Step 13: Registry lookup failed for element_id ID_ce7aacba: ${registry_error}`);
                    await page.screenshot({ path: 'storage/screenshots/pw_step13_input_registry_failed.png' });
                    throw new Error(`Registry lookup failed for element_id ID_ce7aacba: ${registry_error}`);
                }
                await element.fill('${Timestamp}');
                console.log(`✅ Step 13: Filled input with ${Timestamp}`);
                await page.waitForTimeout(500);  // Wait after fill
                await page.screenshot({ path: 'storage/screenshots/pw_step13_input.png' });
            } catch (e) {
                console.log(`❌ Step 13: Failed to fill input: ${e}`);
                await page.screenshot({ path: 'storage/screenshots/pw_step13_input_failed.png' });
                criticalFailures.push(`Step 13: Fill failed`);
            }
